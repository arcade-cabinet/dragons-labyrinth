use bevy::prelude::*;
use crate::resources::{Stats, Abilities, LightDark};
...
pub fn setup_ui(mut commands: Commands) {
    commands.spawn((
        TextBundle::from_section("", TextStyle{ font: Default::default(), font_size: 16.0, color: Color::WHITE })
            ...
            .with_style(Style{ position_type: PositionType::Absolute, left: Val::Px(10.0), top: Val::Px(10.0), ..Default::default() }),
        HudText,
    ));
}
