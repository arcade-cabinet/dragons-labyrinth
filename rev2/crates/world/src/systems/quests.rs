...
fn spawn_quest_ui(commands: &mut Commands) {
    let mut root = commands.spawn((NodeBundle{
        style: Style { position_type: PositionType::Absolute, right: Val::Px(20.0), top: Val::Px(20.0), width: Val::Percent(35.0), height: Val::Percent(60.0), flex_direction: FlexDirection::Column, ..Default::default() },
