// Auto-generated world loader for test_world_dread_2
use bevy::prelude::*;
use hexx::{Hex, HexLayout};

pub fn load_test_world_dread_2_world(
    ...
    // Spawn water tile at (-1, 1)
    commands.spawn((
        SceneBundle {
            scene: asset_server.load("tiles/water_dread0.glb"),
            transform: Transform::from_translation(
                layout.hex_to_world_pos(Hex::new(-1, 1)).extend(0.0)
            ),
            ..default()
    ...
    // Spawn corrupted tile at (0, 2)
    commands.spawn((
        SceneBundle {
            scene: asset_server.load("tiles/corrupted_dread0.glb"),
            transform: Transform::from_translation(
                layout.hex_to_world_pos(Hex::new(0, 2)).extend(0.0)
            ),
            ..default()
        },
        HexPosition(Hex::new(0, 2)),
        TileType::Corrupted,
    ));
