// Auto-generated Cobweb UI component for sanity_meter
use bevy::prelude::*;
use cobweb_ui::prelude::*;

#[derive(Component)]
pub struct SanitymeterUI {
    dread_level: u8,
    degradation_active: bool,
    sanity_level: f32,
}

pub fn spawn_sanitymeter_ui(
...
pub fn update_sanitymeter_degradation(
    mut query: Query<(&mut SanitymeterUI, &mut BackgroundColor)>,
    dread: Res<DreadState>,
    time: Res<Time>,
) {
