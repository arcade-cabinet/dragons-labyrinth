// Auto-generated Cobweb UI component for compass
use bevy::prelude::*;
...
pub fn update_compass_degradation(
    mut query: Query<(&mut CompassUI, &mut BackgroundColor)>,
    dread: Res<DreadState>,
    time: Res<Time>,
) {
