...
// Auto-generated Bevy integration for character variants
// Generated: 2025-08-26T01:20:47.041320
// Total variants: 2
// Sprite sheets: 1
...
pub const KNIGHT_MALE_THIN_YOUNG_HAIR_CLEAN_PALE_PATH: &str = "variants/knight_male_thin_young_hair_clean_pale.png";
pub const KNIGHT_MALE_THIN_YOUNG_HAIR_CLEAN_FAIR_PATH: &str = "variants/knight_male_thin_young_hair_clean_fair.png";

// Sprite sheet path constants  
pub const CHARACTER_KNIGHT_SHEET_PATH: &str = "sprite_sheets/character_knight.png";
pub const CHARACTER_KNIGHT_ATLAS_PATH: &str = "atlases/character_knight.json";

#[derive(Resource, Debug, Clone, Serialize, Deserialize, Default)]
pub struct CharacterVariantAtlas {
...
pub struct CharacterVariantPlugin;

impl Plugin for CharacterVariantPlugin {
    fn build(&self, app: &mut App) {
        app
            .add_systems(Startup, load_character_variants)
            .init_resource::<CharacterVariantAtlas>()
            .add_systems(Update, (
...
fn load_character_variants(
    mut commands: Commands,
    asset_server: Res<AssetServer>,
    mut texture_atlases: ResMut<Assets<TextureAtlas>>,
) {
    let mut variant_atlas = CharacterVariantAtlas::default();
...
pub struct CharacterVariantSelector {
    pub archetype: String,
