...
2. [Horror-First Design](#horror-first-design)
   - [The Journey IS the Game](#the-journey-is-the-game)
   - [Growing Dread Integration](#growing-dread-integration)
   - [Vision-Critical Elements](#vision-critical-elements)
   - [Narrative Arc](#narrative-arc)
3. [Project Rules & Principles](#project-rules--principles)
   - [No External Dependencies](#no-external-dependencies)
   - [Idempotent Code Generation](#idempotent-code-generation)
   - [Component-Based Architecture](#component-based-architecture)
   - [Performance-First Design](#performance-first-design)
4. [Master Metaprompt Architecture](#master-metaprompt-architecture)
   - [Master Generator](#master-generator)
   - [Event-Driven Dependencies](#event-driven-dependencies)
   - [Content-Addressable Generation](#content-addressable-generation)
   - [Narrative Consistency](#narrative-consistency)
5. [Mechanical Prompts System](#mechanical-prompts-system)
   - [Core Concepts](#core-concepts)
   - [Component Categories](#component-categories)
   - [Integration Patterns](#integration-patterns)
   - [Unified Asset Generation](#unified-asset-generation)
6. [Asset Generation Rules](#asset-generation-rules)
   - [Model Generation](#model-generation)
   - [Icon Generation](#icon-generation)
   - [Audio Integration](#audio-integration)
   - [Freesound Blending](#freesound-blending)
...
8. [Biome Generation System](#biome-generation-system)
   - [Universal Biome Metaprompt](#universal-biome-metaprompt)
   - [Biome Types & Variations](#biome-types--variations)
   - [Integrated Audio Bindings](#integrated-audio-bindings)
...
10. [Implementation Standards](#implementation-standards)
    - [Godot Optimization](#godot-optimization)
...
12. [Metaprompt Generation System](#metaprompt-generation-system)
    - [Content Generation Philosophy](#content-generation-philosophy)
    - [Generation Dependency Graph](#generation-dependency-graph)
    - [Structured Data Outputs](#structured-data-outputs)
    - [Staggered Generation Pipeline](#staggered-generation-pipeline)
13. [Design Documents](#design-documents)
    - [Planning Documents](#planning-documents)
    - [Architecture Documents](#architecture-documents)
    - [Example Implementations](#example-implementations)
14. [Future-Proofing](#future-proofing)
...
1. **[Prompt Migration Plan](prompt-migration-plan.md)**
   - Strategy for migrating from monolithic templates to focused metaprompts
   - Identifies vision-critical elements vs generic RPG mechanics
   - Outlines what to keep, what to replace, and why

2. **[Master Metaprompt Architecture](master-metaprompt-architecture.md)**
   - Revolutionary approach where one master generates all system metaprompts
   - Each generated metaprompt understands its role in the horror narrative
   - Includes the opening sequence design (first-person door to hex world)

3. **[Advanced Generation Architecture](advanced-generation-architecture.md)**
   - Content-addressable generation system (Git-like)
   - Event-driven dependencies with narrative cascades
   - Semantic versioning with narrative version numbers
   - Smart regeneration based on meaningful changes

### Architecture Documents

1. **Mechanical Prompt System**
   - [Design Examples](design-examples/Dragon's_Labyrinth_Mechanical_Prompt_System.txt)
   - Component-based architecture with 50-100 line limits
   - Integrated asset generation within prompts

2. **Optimization Patterns**
   - [Hex System Metaprompts](design-examples/Optimized_Dragon's_Labyrinth_Hex_System_Metaprompts.txt)
   - Performance-first design patterns
   - MultiMesh and GPU optimization strategies

### Example Implementations

1. **Quest System Evolution**
   - [Before vs After Comparison](design-examples/Quest_System__Before_vs_After_Mechanical_Prompts.txt)
   - [Growing Dread Implementation](design-examples/Quest_System_Growing_Dread.md)
   - Shows how quests transform from innocent to horror

2. **Biome Generation**
   - [Universal Biome Generator](design-examples/Dragon's_Labyrinth_Universal_Biome_Generator_Metaprompt.txt)
   - Complete metaprompt for generating all biome types
   - Integrated audio and model generation

3. **Code Generation Examples**
   - [Before vs After Comparison](design-examples/Before_vs_After__Code_Generation_Comparison.txt)
   - Demonstrates idempotent generation principles
   - Shows proper component boundaries
...
**RULE**: Semantic versioning for all components:
...
# Migration support
func migrate_from(old_version: String, data: Dictionary) -> Dictionary:
...
**RULE**: Provide migration paths:

```yaml
migrations:
  "1.0.0_to_2.0.0":
    - rename: {"old_field": "new_field"}
    - transform: {"data_structure": "new_structure"}
    - deprecate: ["removed_feature"]
```
...
Dragon's Labyrinth follows these core principles:

1. **AI-Native**: Everything is generated, no external dependencies
2. **Component-Based**: Small, focused, composable pieces
3. **Performance-First**: Optimized for Godot and mobile
4. **Idempotent**: Reproducible generation
5. **Integrated Assets**: Models, icons, and audio are part of components

This design ensures a maintainable, performant, and extensible game generation system that can create complete RPGs from mechanical prompts alone.
