...
pub fn generate_world_resources(out_dir: &std::path::Path) -> Result<()> {
    ...
    println!("📂 Loading organized analysis output from: {}", analysis_output_dir.display());
    println!("🤖 Loading AI-generated models from: {}", models_dir.display());
    ...
    println!("✅ Generated ECS resources: {} regions, {} dungeons, {} settlements, {} factions", 
